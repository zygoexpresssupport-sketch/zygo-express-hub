...
const WA_LINK = `https://wa.me/233202858011?text=${encodeURIComponent(
  "Hi Zygo Express, I'd like to make a delivery enquiry."
)}`;
...
const FAQ_URL =
  "https://zygoexpresssupport-sketch.github.io/zygo-express-hub/public/faq.html";

const PARTNERSHIP_URL =
  "https://zygoexpresssupport-sketch.github.io/zygo-express-hub/public/partnership.html";

const LEGAL_URL =
  "https://zygoexpresssupport-sketch.github.io/zygo-express-hub/public/legal.html";

const MAP_URL = "https://maps.app.goo.gl/BRcQmznphU7dfKjE8";
  ...
  <footer className="bg-gray-900 text-white">
    <div className="container py-12 grid md:grid-cols-3 gap-8">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          <div
            className="h-8 w-8 rounded-lg grid place-items-center font-extrabold text-sm text-white"
          ...
          <span className="font-extrabold text-lg">
            Zygo<span style={{ color: "#f97316" }}>Express</span>
          </span>
        </div>

        <p className="text-gray-400 text-sm leading-relaxed">
          Wa&apos;s fastest delivery service. Legally registered. Real-time
          tracking. From GHS 13.
        </p>
          ...
          <div className="flex gap-3 flex-wrap">
            {SOCIALS.map((s) => (
              <a
                ...
                aria-label={`Follow Zygo Express on ${s.label}`}
      ...
      <div className="space-y-3">
        ...
        {[
          ...
          { label: "Partner with Us", href: PARTNERSHIP_URL },
          { label: "Legal & Policies", href: LEGAL_URL },
          { label: "Office Location", href: MAP_URL },
        ].map((l) => {
      ...
      <div className="space-y-4">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          aria-label="View Zygo Express office location on Google Maps"
          className="flex items-center gap-3 group"
        >
          <div className="h-9 w-9 bg-gray-800 group-hover:bg-orange-500 rounded-xl grid place-items-center transition-colors flex-shrink-0">
    ...
    <div className="border-t border-gray-800 py-5">
      <div className="container flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-gray-500">
        <span>
          © {new Date().getFullYear()} Zygo Express. Legally registered in Wa,
          Upper West Ghana.
        </span>
