  ...
  return (
    <section id="quote" className="py-24 bg-gradient-dark text-secondary-foreground relative overflow-hidden">
      ...
      <div className="container relative grid lg:grid-cols-2 gap-12 items-center">
        ...
        <form onSubmit={onSubmit} className="bg-card text-card-foreground p-6 md:p-8 rounded-2xl shadow-card space-y-4">
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input id="phone" name="phone" placeholder="0244123456" required maxLength={20} />
            </div>
          </div>
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            ...
            <Textarea id="details" name="details" placeholder="Size, weight, special handling..." maxLength={500} />
          </div>
