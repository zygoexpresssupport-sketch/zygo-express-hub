cat > /mnt/user-data/outputs/Index.tsx << 'EOF'
...
// Partnership and FAQ accessible via Navbar dropdown links
// to dedicated pages — keeping Index.tsx lean for performance
...
const MORE_LINKS = [
  { label: "🤝 Partner with Us",    href: "https://zygoexpresssupport-sketch.github.io/zygo-express-hub/public/book.html#partner" },
  { label: "❓ FAQ",                href: "#faq" },
  { label: "📦 Book a Delivery",    href: "https://zygoexpresssupport-sketch.github.io/zygo-express-hub/public/book.html" },
];
      ...
      <div className="container flex items-center justify-between h-16">
        ...
        <a href="#top" className="flex items-center gap-2 shrink-0">
          ...
          <span className="font-extrabold text-lg tracking-tight">
            Zygo<span className="text-primary">Express</span>
          </span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <div className="relative">
            ...
            {moreOpen && (
              <div className="absolute top-8 right-0 w-52 bg-card border border-border rounded-xl shadow-card overflow-hidden z-50">
                {MORE_LINKS.map(l => (
                  <a key={l.label} href={l.href}
